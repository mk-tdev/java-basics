...
public class Student {
    ...
    public Student(
            String countryCode, int yearEnrolled, int ageEnrolled, String gender,
    ...
    public void addCourse(Course newCourse, LocalDate enrolledDate) {
        engagementMap.put(newCourse.courseCode(), new CourseEngagement(
                newCourse, enrolledDate, "Enrollment"
        ));
    }
    ...
    public int getMonthsSinceActive(String courseCode) {
        ...
        return info.getMonthsSinceActive();
    }
